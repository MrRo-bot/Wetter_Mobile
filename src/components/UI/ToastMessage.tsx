  ...
  return (
    <>
      {toasts.map((toast, index) => (
        ...
        >
          <View
            className={`flex-row items-center justify-center gap-2 p-3 border-2 border-solid w-max max-w-[90%] rounded-full overflow-hidden ${theme === "dark" ? "border-light/70 bg-light/90" : "border-dark/30 bg-dark/90"}`}
          >
            <View
